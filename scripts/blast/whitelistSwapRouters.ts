...
async function main() {
  ...
  const swapFunctionSelectors = [
    toFunctionSelector("function swapExactTokensForTokens(uint256,uint256,address[],address,uint256)"),
    toFunctionSelector("function exactInputSingle((address,address,uint24,address,uint256,uint256,uint256,uint160))"),
    toFunctionSelector("function exactInput((bytes,address,uint256,uint256,uint256))"),
    toFunctionSelector(
